    ...
    def forward(self, layer_list):
        ...
        for idx, layer in enumerate(layer_list):
            ...
            if idx != 5:
                ...
                attention_module = self.sigmoid(
                    attention_module.mean(1).unsqueeze(1)
                ).expand_as(latlayer)
        ...
        for i in range(len(self.fpn_architecture) // 2):
            ...
            concat_layer = self.ct(
                latlayer_list[select_concat_layer_idx - 2],
                latlayer_list[select_layer_idx - 2],
                attention_module_list[select_layer_idx - 2],
            )
