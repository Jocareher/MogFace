...
#define __pyx_kp_u_bbox_pyx __pyx_string_tab[10]
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_bbox_pyx, __pyx_mstate->__pyx_n_u_bbox_overlaps, __pyx_k_vQa_V1A_0_T_q_U_1_Cr_AS_2S_Cr_A, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
