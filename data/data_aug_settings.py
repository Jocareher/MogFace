...
class DataAugSettings(object):
    def __init__(
        self,
        das_scale_list=[16, 32, 64, 128, 256, 512],
        p2_scale_range=None,
        p3_scale_range=None,
        p4_scale_range=None,
        p5_scale_range=None,
        p6_scale_range=None,
        p7_scale_range=None,
        img_resize_range=None,
        main_pyramid_layer=None,
        auxiliary_pyramid_layer=None,
        resize_height=640,
        resize_width=640,
        mpl_scale_ratio=None,
        apl_scale_ratio=None,
        sample_bbox_width=640,
        sample_bbox_height=640,
        max_scale=None,
        max_face_size=None,
        use_mst=False,
        min_face_size=8,
